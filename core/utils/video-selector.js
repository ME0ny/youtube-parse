 ...
 * @returns {boolean} true, если текст содержит кириллические символы, иначе false.
 */
function isLikelyRussian(text) {
    if (!text || typeof text !== 'string') return false;
    // Проверяем наличие кириллических букв (русский, украинский, белорусский и т.д.)
    // \u0400-\u04FF - основной блок кириллицы
    // \u0500-\u052F - дополнительный блок (включает буквы из других славянских языков)
